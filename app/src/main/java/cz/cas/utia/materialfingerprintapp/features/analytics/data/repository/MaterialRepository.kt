...
interface MaterialRepository {
    ...
    suspend fun getAllSimilarMaterialsOrderedByName(materialId: Long): List<MaterialSummary> // todo takhle to nedava smysl, musi to byt ordered by Similarity, jelikoz jinak by to nebyly similar materials + u ostatnich metod, kde nejsou similar materials, lze pridat dalsi parametr jako Order a udelat pro to nejaky Enum

    //room material repository bude mit private servicku, ktera mu to spocita
    ...
    suspend fun getSimilarMaterialsOrderedByName(categories: List<MaterialCategory>, nameSearch: String, materialId: Long): List<MaterialSummary>
    suspend fun getSimilarMaterialsOrderedByName(categories: List<MaterialCategory>, nameSearch: String, materialCharacteristics: MaterialCharacteristics): List<MaterialSummary>
